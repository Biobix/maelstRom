...
#'
#' \code{MAGE_ADChromplot} returns various ggplot-objects visualizing MAGE's differential allelic divergence results across a chromosome,
...
MAGE_ADChromplot <- function(AD_Data, DE_Data, Meth_Data=NULL, CNAgain_Data=NULL, CNAloss_Data=NULL, pvalSIG = 0.05, roll_median = 15){
