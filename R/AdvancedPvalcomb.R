...
#' 
#' @param DATAS List. A list containing four elements:
...
#' @param SE Number. Sequencing error.
#' @param nperm Integer. Number of iterations used for correlation-corrected Lancaster p-value combination, which estimates the dependence between samples through a (large) number of sample permutations (default 10000).
#' @export
