...
maelstRom_imprintplot <- function (ref_counts, var_counts, allelefreq, impr, SE, inbr = 0, PlotCov = 50, plot_NoImpr = FALSE, SplitPeaks = FALSE, 
  ...
  pl <- pl + ggplot2::theme(legend.key.width = ggplot2::unit(1, "cm"))
