...
BetaBinomMix_LLDeriv <- function(ref_counts, var_counts, probshift, SE, prr, pvv, prv, theta_hom, theta_het, Der1, Der2 = NULL){
  ...
  if(is.null(Der2)){
    ...
    if(Der1 == "probshift"){
      ...
      OUT <- PreVec*(maelstRom::grad_pi(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het))
      ...
      OUT <- PreVec1*(maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, 1-SE, theta_hom)) +
        PreVec2*(maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, SE, theta_hom))
      ...
      OUT <- PreVec*(maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het))
    ...
    Aterm <- - BetaBinomMix_LLDeriv(ref_counts, var_counts, probshift, SE, prr, pvv, prv, theta_hom, theta_het, Der1 = Der1, Der2 = NULL) *
      BetaBinomMix_LLDeriv(ref_counts, var_counts, probshift, SE, prr, pvv, prv, theta_hom, theta_het, Der1 = Der2, Der2 = NULL)
    ...
    if(Der1 == "probshift"){
      ...
      if(Der2 == "probshift"){
        ...
        Bterm <- PreVec_rv*((maelstRom::grad_pi(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het))^2 +
                              (grad_pi_pi(ms = ref_counts, ns = ref_counts+var_counts, pi = probshift, theta = theta_het)))
        ...
        Bterm <- PreVec_rv*((maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het) *
                               maelstRom::grad_pi(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het)) +
                              grad_pi_theta(ms = ref_counts, ns = ref_counts+var_counts, pi = probshift, theta = theta_het))
      ...
      if(Der2 == "probshift"){
        ...
        Bterm <- PreVec_rr * ((maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, 1-SE, theta_hom))^2 +
                                (grad_theta_theta(ms = ref_counts, ns = ref_counts+var_counts, pi = 1-SE, theta = theta_hom))) +
          PreVec_vv * ((maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, SE, theta_hom))^2 +
                         (grad_theta_theta(ms = ref_counts, ns = ref_counts+var_counts, pi = SE, theta = theta_hom)))
        ...
        Bterm <- PreVec_rr * (((1/prr)*maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, 1-SE, theta_hom))) -
          PreVec2_rr * (((1/prr)*maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, SE, theta_hom)))
        
      } else if (Der2 == "prv"){
        
        Bterm <- - PreVec2_rv * (((1/prv)*maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, SE, theta_hom)))
      ...
      if(Der2 == "probshift"){
        ...
        Bterm <- PreVec_rv * ((maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het))^2 +
                                (grad_theta_theta(ms = ref_counts, ns = ref_counts+var_counts, pi = probshift, theta = theta_het)))
        ...
        Bterm <- PreVec_rv * ((1/prv)*(maelstRom::grad_theta(ms = ref_counts, ns = ref_counts+var_counts, probshift, theta_het)))
