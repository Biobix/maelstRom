...
print(setdiff(unique(ControlCountsToy$Locus), names(controlList)))
```
...
```{r}
print(LancasterPVAL_vec[c(23, 40, 51)])
print(CorLancasterPVAL_vec[c(23, 40, 51)])
```
Most genes, however, consist of more independent SNP-level data (notice the relatively small change):

```{r}
print(LancasterPVAL_vec[1:5])
print(CorLancasterPVAL_vec[1:5])
```
